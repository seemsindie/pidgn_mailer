...
pub fn build(b: *std.Build) void {
    ...
    const async_enabled = b.option(bool, "async", "Enable async delivery via pidgn_jobs") orelse false;
    ...
    mailer_options.addOption([]const u8, "package", "pidgn_mailer");
    ...
    const mod = b.addModule("pidgn_mailer", .{
